                        ...
                        <div className="single-footer-widget">
                            ...
                            <ul className="footer-contact-info">
                                ...
                                <li>
                                    ...
                                    <a href="mailto:hello@hafana.com">hello@hafana.com</a>
                                </li>
                                <li>
                ...
                <div className="footer-bottom-area">
                    <div className="row align-items-center">
                        <div className="col-lg-6 col-md-6">
                            <p><i className='bx bx-copyright'></i>{currentYear} hafana is Proudly Powered by <a target="_blank" href="https://envytheme.com/">EnvyTheme</a></p>
                        </div>
